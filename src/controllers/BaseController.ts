...
export abstract class BaseController<D extends Document> {
	...
	validateId = async (req: Request, resp: Response, next: NextFunction) => {
	...
	findById = async (req: Request, resp: Response, next: NextFunction) => {
		this.prepareOne(this.CurrentModel.findById(req.params.id) as DocumentQuery<D, D>)
			.then(this.render(resp, next))
			.catch(next);
	}

	save = async (req: Request, resp: Response, next: NextFunction) => {
	...
	replace = async (req: Request, resp: Response, next: NextFunction) => {
	...
	update = async (req: Request, resp: Response, next: NextFunction) => {
